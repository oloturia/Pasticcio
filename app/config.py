...
class Settings(BaseSettings):
    ...
    # Leave MAIL_SERVER empty to disable email sending (dev mode).
    # In that case the verification URL is printed to the container logs.
    mail_server: str = ""
    mail_port: int = 587
    mail_username: str = ""
    mail_password: str = ""
    mail_from: str = ""
    mail_from_name: str = "Pasticcio"
