...
async def fork_recipe_form(
    ...
    new_recipe = Recipe(
        ...
        ap_id=fork_ap_id,
        original_language=original_recipe.original_language,
        prep_time_seconds=original_recipe.prep_time_seconds,
        cook_time_seconds=original_recipe.cook_time_seconds,
        servings=original_recipe.servings,
        difficulty=original_recipe.difficulty,
        dietary_tags=list(original_recipe.dietary_tags or []),
        metabolic_tags=list(original_recipe.metabolic_tags or []),
        show_metabolic_disclaimer=original_recipe.show_metabolic_disclaimer,
    )
    ...
    for original_ingredient in original_recipe.ingredients:
        # Copy unit enum directly — SQLAlchemy handles enum-to-enum copy correctly
        new_ingredient = RecipeIngredient(
            recipe_id=new_recipe.id,
            food_item_id=original_ingredient.food_item_id,
            quantity=original_ingredient.quantity,
            unit=original_ingredient.unit,
            name=original_ingredient.name,
            notes=original_ingredient.notes,
            sort_order=original_ingredient.sort_order,
        )
