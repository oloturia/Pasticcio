...
from app.models.recipe import (
    ...
    RecipeStepPhoto, RecipeTranslation, TranslationStatus, IngredientUnit,
)
...
async def edit_recipe_submit(
    ...
    for ing in ingredients:
        try:
            ...
            qty_val = None
        # Convert the unit string from the form to the IngredientUnit enum.
        # The form sends plain strings (e.g. "g", "ml", ""); the model expects the enum.
        try:
            unit_val = IngredientUnit(ing["unit"]) if ing["unit"] else IngredientUnit.NONE
        except ValueError:
